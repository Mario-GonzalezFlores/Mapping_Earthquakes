...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  let tectonicLayer = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";



  // 3. Use d3.json to make a call to get our Tectonic Plate geoJSON data.
  d3.json(tectonicLayer).then(function(data){
    console.log(data);
    L.geoJson(data, ).addTo(tectonicView)
  });
  tectonicView.addTo(map);
